...
class ScramServer(AMP):
    ...
    def valve(self,valveid,state):
        print "Setting Valve state to: %s" % str(state) 
        self.world.plant.setValve(valveid,state)
        return {}
    ...
    def pollPlant(self):
        ...
        self.callRemote(PollPlant, updateid=str(self.update),
                ...
                pressurizervalve=poll['pressurizervalve'],
                explosion=poll['explosion'],
                meltdown=poll['meltdown'],
                damage=poll['damage'],
